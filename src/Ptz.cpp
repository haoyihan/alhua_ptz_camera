...
bool CPtz::PtzExactGo(int param1, int param2, int param3)
{
	return PtzControl(DH_EXTPTZ_EXACTGOTO, param1, param2, param3, false);
}

bool CPtz::PtzReset()
{
	return PtzControl(DH_EXTPTZ_RESTART,0,0,0, false);
}
